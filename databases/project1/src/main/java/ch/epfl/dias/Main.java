...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// System.out.println(rowstore.getRow(5).getFieldAsString(8));

		// PAXStore paxstore = new PAXStore(orderSchema, "input/orders_small.csv", "\\|", 3);
		// paxstore.load();
		// System.out.println(paxstore.paxpages.size());
		 ...
		 //int[] cols =  {0,1,2};
		 //System.out.println(Arrays.toString(columnstoreData.getColumns(cols)[1].getAsInteger()));
